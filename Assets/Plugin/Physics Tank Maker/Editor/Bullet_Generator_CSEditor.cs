...
namespace ChobiAssets.PTM
{
	...
	public class Bullet_Generator_CSEditor : Editor
	{
		...
		void  OnEnable ()
		{
			...
			//ATGM_Bullet_PrefabProp = serializedObject.FindProperty("ATGM_Bullet_Prefab");
			...
			//Attack_Point_ATGMProp = serializedObject.FindProperty("Attack_Point_ATGM");
			...
			//Initial_Velocity_ATGMProp = serializedObject.FindProperty("Initial_Velocity_ATGM");
		...
		public override void  OnInspectorGUI ()
		{
			...
			//ATGM_Bullet_PrefabProp.objectReferenceValue = EditorGUILayout.ObjectField("ATGM Bullet Prefab", ATGM_Bullet_PrefabProp.objectReferenceValue, typeof(GameObject), true);
			//bullets.objectReferenceValue = EditorGUILayout.ObjectField("bullets", bullets.objectReferenceValue, typeof (BulletSettings), true);
			EditorGUILayout.Space ();
			...
			//EditorGUILayout.Slider(Attack_Point_ATGMProp, 0.0f, 10000.0f, "ATGM Attack Point");
			...
			//EditorGUILayout.Slider(Initial_Velocity_ATGMProp, 0.0f, 1000.0f, "ATGM Initial Velocity");
			EditorGUILayout.Space ();
