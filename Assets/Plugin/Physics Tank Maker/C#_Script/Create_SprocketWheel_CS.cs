	...
	public class Create_SprocketWheel_CS : MonoBehaviour
	{
		...
		*/
        ...
        void Set_Static_Wheel_Parent_Script()
        {
            ...
            Static_Wheel_Parent_CS staticWheelParentScript = transform.GetComponent<Static_Wheel_Parent_CS>();
            if (staticWheelParentScript == null)
            {
                staticWheelParentScript = transform.gameObject.AddComponent<Static_Wheel_Parent_CS>();
            }
            Mesh wheelMesh = Wheel_Mesh as Mesh;
        ...
        void Create_Static_Wheel(string direction, Vector3 position)
        {
            ...
            staticWheelScript.Parent_Script = transform.GetComponent<Static_Wheel_Parent_CS>();
        }
        ...
        void Create_Invisible_Wheel(string direction, Vector3 position)
        {
            ...
            meshFilter.mesh = Wheel_Mesh as Mesh;
        ...
        void Add_SphereCollider(GameObject gameObject)
        {
            ...
            sphereCollider.material = Collider_Material as PhysicMaterial;
