...
namespace TheVisualEngine
{
    ...
    public class TVETerrain : StyledMonoBehaviour
    {
        ...
        public TVETerrainRefresh terrainRefresh = TVETerrainRefresh.Selection;
        ...
        void CopyLayerSettings(MaterialPropertyBlock materialPropertyBlock, TerrainLayer layer, int id)
        {
            ...
            {
                materialPropertyBlock.SetTexture("_TerrainAlbedoTex" + id, whiteTex);
            }
            ...
            {
                materialPropertyBlock.SetTexture("_TerrainNormalTex" + id, normalTex);
            }
            ...
            {
                materialPropertyBlock.SetTexture("_TerrainShaderTex" + id, whiteTex);
            }
