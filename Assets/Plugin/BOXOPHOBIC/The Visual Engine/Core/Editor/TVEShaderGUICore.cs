...
public class TVEShaderGUICore : ShaderGUI
{
    ...
    void DrawDynamicInspector(Material material, MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        searchText = TVEUtils.DrawSearchField(searchText, out searchResult, 2);
        ...
        for (int i = 0; i < customPropsList.Count; i++)
        {
            ...
            TVEUtils.GetActiveDisplay(material, internalName, "_DitherCategory", new string[] { "_DitherConstantValue", "_DitherProximityValue", "_DitherGlancingValue" }, "D2D2D2", subTitleStyle);
            ...
            TVEUtils.GetActiveDisplay(material, internalName, "_NormalCategory", new string[] { "_NormalFlattenValue", "_NormalSphereValue", "_NormalComputeValue", "_NormalElementValue" }, "9393FF", subTitleStyle);
        }
