...
namespace TheVisualEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        {
        "All Material Settings", "Render Settings", "Surface Settings", "Coloring Settings", "Weather Settings", "Clipping Settings", "Glowing Settings", "Transform Settings", "Motion Settings", "Normal Settings",
        };
        ...
        List<TVEPropertyData> coloringData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_VariationNoiseTillingValue", "Variation Noise Tilling", -9000, 0, 40, false, false),
            ...
            new TVEPropertyData("_TintingNoiseTillingValue", "Tinting Noise Tilling", -9000, 0, 40, false, false),
        ...
        List<TVEPropertyData> weatherData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_DrynessNoiseTillingValue", "Dryness Noise Tilling", -9000, 0, 40, false, false),
            ...
            new TVEPropertyData("_OverlayGlitterDistValue", "Overlay Glitter Fade", -9000, 0, 200, false, false),
            ...
            new TVEPropertyData("_OverlayNoiseTillingValue", "Overlay Noise Tilling", -9000, 0, 40, false, false),
            ...
            new TVEPropertyData("_WetnessDropsDistValue", "Wetness Drops Fade", -9000, 0, 40, false, false),
        ...
        List<TVEPropertyData> clippingData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_CutoutIntensityValue", "Cutout Constant", -9000, 0, 1, false, false),
            ...
            new TVEPropertyData("_CutoutNoiseTillingValue", "Cutout Noise Tilling", -9000, 0, 40, false, false),
            ...
            new TVEPropertyData("_DitherProximityDistValue", "Dither Proximity Fade", -9000, 0, 40, false, false),
            new TVEPropertyData("_DitherGlancingValue", "Dither Glancing", -9000, 0, 1, false, false),
            new TVEPropertyData("_DitherGlancingAngleValue", "Dither Glancing Angle", -9000, 0, 1, false, false),
            ...
            new TVEPropertyData("_DitherNoiseTillingValue", "Dither Noise Tilling", -9000, 0, 40, false, false),
        };
        ...
        List<TVEPropertyData> glowingData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_EmissiveColorMode", "Emissive Value", -9000, "Constant 0 Multiply_with_Base_Albedo 1", false),
        ...
        List<TVEPropertyData> motionData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_MotionHighlightValue", "Motion Wave Intensity", -9000, 0, 1, false, true),
            new TVEPropertyData("_MotionHighlightColor", "Motion Wave Color", new Color(-9000, 0,0,0), true, false),

            new TVEPropertyData("_MotionBaseIntensityValue", "Motion 01 Intensity", -9000, 0, 8, false, true),
            new TVEPropertyData("_MotionBasePivotValue", "Motion 01 Pivots", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionBasePhaseValue", "Motion 01 Phase", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionBaseMaskMode", "Motion 01 Anim Mask", -9000, "Vertex_R 0 Vertex_G 1 Vertex_B 2 Vertex_A 3 Height 4 Sphere 5", false),
            new TVEPropertyData("_MotionBaseMaskRemap", "Motion 01 Anim Mask", new Vector4(-9000, 0, 0, -9000), 0, 1, false),

            new TVEPropertyData("_MotionSmallIntensityValue", "Motion 02 Intensity", -9000, 0, 8, false, true),
            new TVEPropertyData("_MotionSmallPivotValue", "Motion 02 Pivots", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionSmallPhaseValue", "Motion 02 Phase", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionSmallMaskMode", "Motion 02 Anim Mask", -9000, "Vertex_R 0 Vertex_G 1 Vertex_B 2 Vertex_A 3 Height 4 Sphere 5", false),
            new TVEPropertyData("_MotionSmallMaskRemap", "Motion 02 Anim Mask", new Vector4(-9000, 0, 0, -9000), 0, 1, false),

            new TVEPropertyData("_MotionTinyIntensityValue", "Motion 03 Intensity", -9000, 0, 8, false, true),
            new TVEPropertyData("_MotionTinyTillingValue", "Motion 03 Tilling", -9000, 0, 40, false, false),
            new TVEPropertyData("_MotionTinySpeedValue", "Motion 03 Speed", -9000, 0, 40, false, false),
            new TVEPropertyData("_MotionTinyPhaseValue", "Motion 03 Phase", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionTinyMaskMode", "Motion 03 Anim Mask", -9000, "Vertex_R 0 Vertex_G 1 Vertex_B 2 Vertex_A 3 Height 4 Sphere 5", false),
            new TVEPropertyData("_MotionTinyMaskRemap", "Motion 03 Anim Mask", new Vector4(-9000, 0, 0, -9000), 0, 1, false),

            new TVEPropertyData("_MotionIntensityValue", "Motion Wind Intensity", -9000, 0, 1, false, true),
            new TVEPropertyData("_MotionNoiseValue", "Motion Wind Noise", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionTillingValue", "Motion Wind Tilling", -9000, 0, 40, false, false),
            new TVEPropertyData("_MotionSpeedValue", "Motion Wind Speed", -9000, 0, 40, false, false),
            new TVEPropertyData("_MotionDistValue", "Motion Wind Flutter Fade", -9000, 0, 200, false, false),
            ...
            new TVEPropertyData("_MotionInteractionElementMode", "Use Push Elements", -9000, true),
        };
        ...
        void OnGUI()
        {
            ...
            if (isValid)
            {
                ...
                searchText = TVEUtils.DrawSearchField(searchText, out searchResult, 6);
        ...
        void DrawProperties()
        {
            for (int i = 0; i < propertyDataSet.Count; i++)
            {
                ...
                {
                    if (propertyData.prop == "_MotionNoiseTex")
                    {
                        DrawWindPower();
                    }
                }
