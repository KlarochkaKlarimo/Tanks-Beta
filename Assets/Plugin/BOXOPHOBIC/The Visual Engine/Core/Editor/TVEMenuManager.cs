        ...
        static void CreateElement()
        {
            ...
            if (Selection.activeGameObject != null)
            {
                if (Selection.activeGameObject.GetComponent<Terrain>() != null)
                {
                    ...
                    var assignTerrainData = EditorUtility.DisplayDialog("Assign Terrain Data?", "Use the Assign Terrain Data option to transfer the textures from the terrain to the element! You can skip the process if you only want the element to match the terrain size.", "Assign Terrain Data", "Skip");
