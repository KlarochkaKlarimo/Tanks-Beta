...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFadeCutout
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g23479 = _SeasonRemap.x;
				half temp_output_10_0_g23479 = ( _SeasonRemap.y - temp_output_7_0_g23479 );
				half TVE_SeasonLerp54_g23453 = saturate( saturate( ( ( TVE_SeasonLerp - temp_output_7_0_g23479 ) / temp_output_10_0_g23479 ) ) );
				...
				half2 vertexToFrag11_g23490 = ( ( lerpResult1899_g23453 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23490;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23490 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23453 = tex2D( _MainTex, vertexToFrag11_g23490 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23484 = clamp( (MainTex_RGBA587_g23453).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g23465 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g23465).xxx;
				half temp_output_10_0_g23465 = ( _MainTexColorRemap.y - temp_output_7_0_g23465 );
				half3 temp_output_1765_0_g23453 = saturate( ( ( clampResult17_g23484 - temp_cast_2 ) / temp_output_10_0_g23465 ) );
				...
				half clampResult17_g23485 = clamp( (MainTex_RGBA587_g23453).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23464 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23464 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23464 );
				half Element_Remap_A74_g23453 = saturate( ( ( clampResult17_g23485 - temp_output_7_0_g23464 ) / ( temp_output_10_0_g23464 + 0.0001 ) ) );
				half Element_Params_A1737_g23453 = _ElementParams_Instance.w;
				half clampResult17_g23462 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g23463 = _MainTexFalloffRemap.x;
				half temp_output_10_0_g23463 = ( _MainTexFalloffRemap.y - temp_output_7_0_g23463 );
				half Element_Falloff1883_g23453 = saturate( ( ( clampResult17_g23462 - temp_output_7_0_g23463 ) / ( temp_output_10_0_g23463 + 0.0001 ) ) );
				half temp_output_7_0_g23489 = 1.0;
				half temp_output_10_0_g23489 = ( _ElementVolumeFadeValue - temp_output_7_0_g23489 );
				half lerpResult18_g23487 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23489 ) / temp_output_10_0_g23489 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23453 = ( _ElementIntensity * Element_Remap_A74_g23453 * Element_Params_A1737_g23453 * i.ase_color.a * Element_Falloff1883_g23453 * lerpResult18_g23487 );
				half lerpResult1634_g23453 = lerp( 1.0 , Final_Extras_RGB213_g23453 , Element_Alpha56_g23453);
				half Element_BlendA918_g23453 = _ElementBlendA;
				half lerpResult933_g23453 = lerp( lerpResult1634_g23453 , ( Final_Extras_RGB213_g23453 * Element_Alpha56_g23453 ) , Element_BlendA918_g23453);
				half Final_Extras_Blend211_g23453 = lerpResult933_g23453;
				half4 appendResult472_g23453 = (half4(Final_Extras_RGB213_g23453 , 0.0 , 0.0 , Final_Extras_Blend211_g23453));
				
				
				finalColor = appendResult472_g23453;
				return finalColor;
			}
			ENDCG
		}
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFadeCutout
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23475 = temp_cast_3;
				half3 break68_g23475 = Input_Color94_g23475;
				half clampResult80_g23475 = clamp( max( max( break68_g23475.x , break68_g23475.y ) , break68_g23475.z ) , 0.1 , 10000.0 );
				half4 color1875_g23453 = IsGammaSpace() ? half4(0.5,0.5,0.5,0) : half4(0.2140411,0.2140411,0.2140411,0);
				half3 Input_Tint76_g23475 = (color1875_g23453).rgb;
				half3 Element_Valid47_g23475 = ( clampResult80_g23475 * Input_Tint76_g23475 );
				half clampResult17_g23485 = clamp( (MainTex_RGBA587_g23453).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23464 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23464 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23464 );
				half Element_Remap_A74_g23453 = saturate( ( ( clampResult17_g23485 - temp_output_7_0_g23464 ) / ( temp_output_10_0_g23464 + 0.0001 ) ) );
				...
				half Input_Alpha48_g23475 = Final_Extras_A241_g23453;
				half4 appendResult58_g23475 = (half4(Element_Valid47_g23475 , Input_Alpha48_g23475));
				
				
				finalColor = appendResult58_g23475;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.FunctionNode;147;-640,-1024;Inherit;False;Element Atmo;1;;23450;825a873635c1c404399c06fe163ce11a;0;0;1;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;112;-640,-1280;Inherit;False;Property;_render_src;_render_src;69;1;[HideInInspector];Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-480,-1280;Inherit;False;Property;_render_dst;_render_dst;70;1;[HideInInspector];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;151;-384,-1024;Inherit;False;Element Shader;10;;23453;0e972c73cae2ee54ea51acc9738801d0;12,477,1,1778,1,478,0,1824,0,1814,3,145,3,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
...
WireConnection;151;1974;147;4
WireConnection;139;0;151;0
WireConnection;140;0;151;1779
ASEEND*/
//CHKSM=BF2B0DA11DBD1553740405A7A52E26C853E7F919