...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoRaindrops
			...
			v2f vert ( appdata v )
			{
				...
				half2 vertexToFrag11_g23813 = ( ( lerpResult1899_g23776 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23813;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23813 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23776 = tex2D( _MainTex, vertexToFrag11_g23813 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23807 = clamp( (MainTex_RGBA587_g23776).rgb , temp_cast_0 , temp_cast_1 );
				...
				half3 temp_output_1765_0_g23776 = saturate( ( ( clampResult17_g23807 - temp_cast_2 ) / temp_output_10_0_g23788 ) );
				...
				half clampResult17_g23808 = clamp( (MainTex_RGBA587_g23776).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23787 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23787 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23787 );
				half Element_Remap_A74_g23776 = saturate( ( ( clampResult17_g23808 - temp_output_7_0_g23787 ) / ( temp_output_10_0_g23787 + 0.0001 ) ) );
				...
				half temp_output_7_0_g23812 = 1.0;
				half temp_output_10_0_g23812 = ( _ElementVolumeFadeValue - temp_output_7_0_g23812 );
				half lerpResult18_g23810 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23812 ) / temp_output_10_0_g23812 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23776 = ( _ElementIntensity * Element_Remap_A74_g23776 * Element_Params_A1737_g23776 * i.ase_color.a * Element_Falloff1883_g23776 * lerpResult18_g23810 );
...
ASEEND*/
//CHKSM=8782C91A8EC2116F3194A37696D5B25A1F8C3BAD